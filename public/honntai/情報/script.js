  ...
  survivors.forEach((survivor) => {
    ...
    card.innerHTML = `
            <a href="${survivor.link}">
                <img src="${survivor.url}" alt="${survivor.name}">
                <h2>${survivor.name}</h2>
            </a>
        `;
...
function createHunterCards() {
  ...
  hunters.forEach((hunter) => {
    ...
    card.innerHTML = `
            <a href="${hunter.link}">
                <img src="${hunter.url}" alt="${hunter.name}">
                <h2>${hunter.name}</h2>
            </a>
        `;
