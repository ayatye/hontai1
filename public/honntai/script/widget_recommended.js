// widget_recommended.js - 今日のおすすめ記事のみ生成（CSS完全版）
// index.htmlで widget.js の代わりに読み込んでください
...
(function () {
  const recommendedArticles = [
    {
      ...
      description: "初心者から中級者になるための、確実なステップを詳しく解説！",
      category: "初心者向け",
    ...
    },
    {
      ...
      description:
        "各能力ごとに基準値から外れているキャラクターをまとめて紹介します。",
      category: "キャラクター身体能力",
    ...
    },
    {
      ...
      description:
        "第五人格始めて何のサバイバー、ハンター使ったら良いのか分からない方向けにランキング形式で紹介！",
      category: "初心者向け",
  ...
  function insertRecommended() {
    const container = document.getElementById("recommended-widget");
    if (!container) return;
